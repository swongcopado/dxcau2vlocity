...
import { OMNIDEF } from './testChildEnglish_def.js';
import tmpl from './testChildEnglish.html';
import tmpl_nds from './testChildEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class testChildEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
