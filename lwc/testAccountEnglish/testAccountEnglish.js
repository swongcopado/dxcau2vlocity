...
import { OMNIDEF } from './testAccountEnglish_def.js';
import tmpl from './testAccountEnglish.html';
import tmpl_nds from './testAccountEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class testAccountEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
