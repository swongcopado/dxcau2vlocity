...
import { OMNIDEF } from './testBlank2English_def.js';
import tmpl from './testBlank2English.html';
import tmpl_nds from './testBlank2English_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class testBlank2English extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
