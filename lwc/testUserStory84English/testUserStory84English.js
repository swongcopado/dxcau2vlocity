...
import { OMNIDEF } from './testUserStory84English_def.js';
import tmpl from './testUserStory84English.html';
import tmpl_nds from './testUserStory84English_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class testUserStory84English extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
