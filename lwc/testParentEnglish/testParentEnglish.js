...
import { OMNIDEF } from './testParentEnglish_def.js';
import tmpl from './testParentEnglish.html';
import tmpl_nds from './testParentEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class testParentEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
