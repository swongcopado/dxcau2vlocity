...
import { OMNIDEF } from './getAccountReusableComponentEnglish_def.js';
import tmpl from './getAccountReusableComponentEnglish.html';
import tmpl_nds from './getAccountReusableComponentEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class getAccountReusableComponentEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
