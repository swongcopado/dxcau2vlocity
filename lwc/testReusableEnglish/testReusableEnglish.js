...
import { OMNIDEF } from './testReusableEnglish_def.js';
import tmpl from './testReusableEnglish.html';
import tmpl_nds from './testReusableEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class testReusableEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
