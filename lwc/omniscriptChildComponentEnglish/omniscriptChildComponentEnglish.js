...
import { OMNIDEF } from './omniscriptChildComponentEnglish_def.js';
import tmpl from './omniscriptChildComponentEnglish.html';
import tmpl_nds from './omniscriptChildComponentEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class omniscriptChildComponentEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
