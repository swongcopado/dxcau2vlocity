...
import { OMNIDEF } from './testCssJsEnglish_def.js';
import tmpl from './testCssJsEnglish.html';
import tmpl_nds from './testCssJsEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class testCssJsEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
