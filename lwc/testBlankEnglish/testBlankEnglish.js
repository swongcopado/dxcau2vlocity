...
import { OMNIDEF } from './testBlankEnglish_def.js';
import tmpl from './testBlankEnglish.html';
import tmpl_nds from './testBlankEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class testBlankEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
