...
import { OMNIDEF } from './testPipeConfigEnglish_def.js';
import tmpl from './testPipeConfigEnglish.html';
import tmpl_nds from './testPipeConfigEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class testPipeConfigEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
