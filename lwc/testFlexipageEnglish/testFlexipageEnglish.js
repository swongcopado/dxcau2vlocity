...
import { OMNIDEF } from './testFlexipageEnglish_def.js';
import tmpl from './testFlexipageEnglish.html';
import tmpl_nds from './testFlexipageEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class testFlexipageEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
